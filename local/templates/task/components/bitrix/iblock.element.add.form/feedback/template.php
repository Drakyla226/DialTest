...
<? endif ?>
<form name="iblock_add" class="form-modal" action="<?= POST_FORM_ACTION_URI ?>" method="post" enctype="multipart/form-data">
	<?= bitrix_sessid_post() ?>
	...
	<? if (is_array($arResult["PROPERTY_LIST"]) && !empty($arResult["PROPERTY_LIST"])) : ?>
		...
		<? foreach ($arResult["PROPERTY_LIST"] as $propertyID) : ?>
			<div class="modal-element">
				...
				if($arResult["PROPERTY_LIST_FULL"][$propertyID]["CODE"] == 'PHONE'):
					$title = 'Ваш номер (без кода)*" data-mask="phone"';
				endif;
				...
				?><br /><?
					...
					case "N":
						...
						?>
							...
							<input placeholder="<?=$title?>" class="modal-element" type="text" name="PROPERTY[<?= $propertyID ?>][<?= $i ?>]" size="<?= $arResult["PROPERTY_LIST_FULL"][$propertyID]["COL_COUNT"]; ?>" value="<?= $value ?>" /><br /><?
		...
		<div>
		<button class="btn-close" easy-toggle="#modal" easy-class="hidden" easy-rcoe>X</button>
		<input type="submit" class="btn" name="iblock_submit" value="Заказать звонок" />
	</div>
	<? endif ?>
